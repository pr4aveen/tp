...
class RemarkCommandTest {
    ...
    public void execute_invalidPersonIndexFilteredList_failure() {
        ...
        Assertions.assertTrue(outOfBoundsIndex.getZeroBased() < model.getAddressBook().getPersonList().size());

        RemarkCommand remarkCommand = new RemarkCommand(outOfBoundsIndex, new Remark(VALID_REMARK_BOB));
        assertCommandFailure(remarkCommand, model, Messages.MESSAGE_INVALID_PERSON_DISPLAYED_INDEX);
    }
}
